...
class Carousel extends Component
{
    ...
    {
        return view('livewire.backend.carousel.carousel');
    }

    public function restore($id)
    {
        ModelsCarousel::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsCarousel::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsCarousel::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsCarousel::where('id', $this->selectedItem)->delete();
        } else {
            ModelsCarousel::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
        $this->dispatchBrowserEvent('success-izi', ['ntitle' => 'Success', 'nmessage' => "Gambar Slider has been deleted"]);
        $this->clear();
