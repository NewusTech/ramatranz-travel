...
class Jadwals extends Component
{
    ...
    {
        return view('livewire.backend.jadwal.jadwals');
    }
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            Jadwal::whereIn('id', $this->selectedItems)->delete();
        } else {
            Jadwal::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            Jadwal::where('id', $this->selectedItem)->delete();
        } else {
            Jadwal::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
