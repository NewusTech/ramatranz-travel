...
class Faqs extends Component
{
    ...
    {
        return view('livewire.backend.faq.faqs');
    }
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            Faq::whereIn('id', $this->selectedItems)->delete();
        } else {
            Faq::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            Faq::where('id', $this->selectedItem)->delete();
        } else {
            Faq::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
        $this->dispatchBrowserEvent('success-izi', ['ntitle' => 'Success', 'nmessage' => "Faq has been deleted"]);
        $this->clear();
