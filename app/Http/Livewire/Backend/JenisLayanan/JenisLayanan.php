...
use App\Models\JenisLayanan as ModelsJenisLayanan;
...
class JenisLayanan extends Component
{
    ...
    {
        return view('livewire.backend.jenis-layanan.jenis-layanan');
    }

    public function restore($id)
    {
        ModelsJenisLayanan::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsJenisLayanan::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsJenisLayanan::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsJenisLayanan::where('id', $this->selectedItem)->delete();
        } else {
            ModelsJenisLayanan::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
