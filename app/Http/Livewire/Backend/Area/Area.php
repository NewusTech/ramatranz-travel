...
class Area extends Component
{
    ...
    {
        return view('livewire.backend.area.area');
    }

    public function restore($id)
    {
        ModelsArea::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsArea::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsArea::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsArea::where('id', $this->selectedItem)->delete();
        } else {
            ModelsArea::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
