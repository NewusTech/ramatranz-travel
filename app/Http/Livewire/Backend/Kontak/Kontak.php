...
class Kontak extends Component
{
    ...
    {
        return view('livewire.backend.kontak.kontak');
    }

    public function restore($id)
    {
        ModelsKontak::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsKontak::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsKontak::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsKontak::where('id', $this->selectedItem)->delete();
        } else {
            ModelsKontak::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
