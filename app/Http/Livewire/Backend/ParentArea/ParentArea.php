...
use App\Models\ParentArea as ModelsParentArea;
use Livewire\Component;

class ParentArea extends Component
{
    ...
    {
        return view('livewire.backend.parent-area.parent-area');
    }

    public function restore($id)
    {
        ModelsParentArea::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsParentArea::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsParentArea::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsParentArea::where('id', $this->selectedItem)->delete();
        } else {
            ModelsParentArea::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
