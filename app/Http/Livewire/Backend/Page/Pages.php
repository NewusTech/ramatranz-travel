...
class Pages extends Component
{
    ...
    {
        return view('livewire.backend.page.pages');
    }
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            Page::whereIn('id', $this->selectedItems)->delete();
        } else {
            Page::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            Page::where('id', $this->selectedItem)->delete();
        } else {
            Page::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
        $this->dispatchBrowserEvent('success-izi', ['ntitle' => 'Success', 'nmessage' => "Page has been deleted"]);
        $this->clear();
