...
use App\Models\Unggulan as ModelsUnggulan;
...
class Unggulan extends Component
{
    ...
    {
        return view('livewire.backend.unggulan.unggulan');
    }

    public function restore($id)
    {
        ModelsUnggulan::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsUnggulan::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsUnggulan::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsUnggulan::where('id', $this->selectedItem)->delete();
        } else {
            ModelsUnggulan::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
